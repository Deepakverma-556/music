        ...
        <div id='home' className='pt-[10px] pb-10'>
            ...
            <div className='max-w-[1160px] mx-auto px-4'>
                ...
                <div className='bg-customBlack rounded-[22px] flex pl-12 pr-[43px] justify-between pt-[38px] mt-[35px] relative pb-[43px] max-sm:flex-wrap max-sm:pt-4 max-sm:px-5 max-sm:pb-20'>
                    ...
                    <div id='top-artist' className='absolute flex items-center gap-[26px] -bottom-16 max-lg:-bottom-10 max-sm:-bottom-6'>
                        ...
                        <div>
                            ...
                            <p id='release' className='font-montserrat font-medium text-base leading-5 text-darkGray pt-[5px] max-lg:pt-0 pb-[21px] max-sm:text-sm'>Released May 17, 2024</p>
                        </div>
                    </div>
                </div>
            </div>
